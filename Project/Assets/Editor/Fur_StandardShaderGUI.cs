...
namespace UnityEditor
{
    internal class Fur_StandardShaderGUI : ShaderGUI
    {
        ...
        MaterialProperty LayerChoice=null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            LayerChoice=FindProperty("_LayerChoice",props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                //It's hard to control the number of the shader's pass,so I write a new shader which only
                //has ten pass;
                
                //m_MaterialEditor.ShaderProperty(LayerChoice,"LayerNumber Choices");
        ...
        static void MaterialChanged(Material material, WorkflowMode workflowMode, bool overrideRenderQueue)
        {
            ...
            // int layerChoice=(int)material.GetInt("_LayerChoice");
            // if(layerChoice==0){
            //     material.DisableKeyword("_TENLAYERS");
            // }
            // else{
            //     material.EnableKeyword("_TENLAYERS");
            // }
