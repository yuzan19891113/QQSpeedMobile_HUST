...
{
    internal class yarn_StandardShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            warpAndWeft = FindProperty("_WarpAndWeft", props);
            judge = FindProperty("_Judge", props);
            ...
            anistro = FindProperty("_Anistropy", props);
            SpecMag = FindProperty("_SpecMag", props);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label(Styles.GauzeText, EditorStyles.boldLabel);
                m_MaterialEditor.ShaderProperty(rimPower, Styles.rimPowerText);
                m_MaterialEditor.ShaderProperty(denier, Styles.denierText);
                m_MaterialEditor.ShaderProperty(specular, Styles.specularText);
                m_MaterialEditor.ShaderProperty(warpAndWeft, Styles.warpAndWeftText);
                m_MaterialEditor.ShaderProperty(judge, Styles.judgeText);
                m_MaterialEditor.ShaderProperty(density, Styles.densityText);
                m_MaterialEditor.ShaderProperty(fabricScatterColor, Styles.fabricScatterColorText);
                m_MaterialEditor.ShaderProperty(fabricScatterScale, Styles.fabricScatterScaleText);
                m_MaterialEditor.ShaderProperty(anistro, Styles.anistroText);
                m_MaterialEditor.ShaderProperty(SpecMag, Styles.specMagText);
            }
            if (EditorGUI.EndChangeCheck())
            {
